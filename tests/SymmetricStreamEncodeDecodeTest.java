...
import crypto.SymmetricInputStream;
import crypto.SymmetricOutputStream;
...
public class SymmetricStreamEncodeDecodeTest {
    ...
    public void testEncryptingDecryptingStreamsSingleLine() throws IOException {
        for (int i = 2; i < 11; i++) {
            ...
            byte[] symmetricKey = KeyGenerator.generateSymmetricKey(keyLength);
            ...
            OutputStream out = new SymmetricOutputStream(symmetricKey, buffer);
            ...
            InputStream in = new SymmetricInputStream(symmetricKey, new
